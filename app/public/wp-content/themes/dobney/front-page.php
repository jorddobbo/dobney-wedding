<div class="dbo dbo--home">
	...
	<?php get_header(); ?>
		...
		<div id="dbo--particles" class="dbo--home__photos">
			<div class="dbo__container">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/img/home/home__us.png" />
			</div>
		</div>

		<div class="dbo--home__info">
			<h2>19th <span>May</span> 2018</h2>

			<div class="half">
				<div class="left">
					<p>The Riding School<br>
					Calke Abbey<br>
					Ticknall<br>
					Derbyshire</p>
				</div>
